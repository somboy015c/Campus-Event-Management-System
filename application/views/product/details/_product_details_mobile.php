...
<?php if ($product->product_type == 'digital'):
	...
	<div class="row-custom price" style="margin-bottom: 15px;">
		<span style="font-weight: 100; font-size: 14px;"><?php if ($product->qty_scale == ' (Pieces)') { $cond = ', (Pieces)'; echo "Basic Ticket"; } elseif ($product->qty_scale == ' (Bulk)') { $cond = ', ' . $product->qty_scale . ', ' . $product->bulk_quantity . ' Pieces In A Bulk'; echo "Silver Ticket"; } elseif ($product->qty_scale == ' (Company Sales)') {$cond = ''; echo "Gold Ticket";} else {$cond = '';} ?></span>
	</div>
