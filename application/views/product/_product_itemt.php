...
<?php if (empty($product->post_type)): ?>
	...
	<div class="product-item" style="margin: 0px;">
		<div class="row-custom"><?php $this->load->view('product/_price_product_item', ['product' => $product]); ?>
		...
		<?php endif ?>
			<a href="<?php echo generate_product_url($product); ?>">
					<img src="<?php echo $img_bg_product_small; ?>" data-src="<?php echo get_product_image($product->id, 'image_small'); ?>" alt="<?php echo html_escape($product->title); ?>" style="width: 240px; height: 240px; padding-top: 6px;" class="lazyload img-fluid img-product" onerror="this.src='<?php echo $img_bg_product_small; ?>'">
			</a>
	...
	<div class="product-item" style="margin: 0px;">
		...
		<div class="grid-item">
	        <div class="image_card" style="height: 300px; margin-top: 15px;">
	            ...
	            <div class="card__info" style="padding-top: 12px;">
	                <h3 class="card_title"><?php $num_len = strlen($product->title); if ($num_len > 12) { echo substr($product->title, 0, 10) . ".."; } else { echo $product->title;} ?></h3>
	                <span class="card_by">by&nbsp;</span><span class="card_by" style="padding-top: 0px;"><a href="<?php echo lang_base_url() . "profile" . '/' . html_escape($product->user_slug); ?>" class="card_author" title="author"><?php echo get_shop_name_product($product); ?></a></span>
	            </div>
	        </div>
			<?php if ($product->is_promoted && $promoted_products_enabled == 1 && isset($promoted_badge) && $promoted_badge == true): ?>
				<span class="badge badge-dark badge-promoted"><?php echo trans("promoted"); ?></span>
