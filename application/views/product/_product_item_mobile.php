	...
	<div class="product-item" style="margin: 0px;">
		...
		<div class="grid-item">
	        <div class="image_card" style="height: 240px; margin-top: 12px; margin-bottom: 5px;">
	            ...
	            <div class="card__info" style="padding: 16px 7px 24px 7px; text-align: center;">
	                <h3 class="card_title" style="font-size: 16px;"><?php $num_len = strlen($product->title); if ($num_len > 12) { echo substr($product->title, 0, 10) . ".."; } else { echo $product->title;} ?></h3>
