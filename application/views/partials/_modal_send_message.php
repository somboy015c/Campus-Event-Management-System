...
<!-- Send Message Modal -->
<?php if (auth_check()): ?>
    <div class="modal fade" id="messageModal" tabindex="-1" role="dialog" style="top: 18px;z-index: 999999">
        <div class="modal-dialog modal-dialog-centered modal-send-message login-modal" role="document" style="min-width: unset;">
