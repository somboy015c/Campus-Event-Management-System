...
<?php if (!empty($ad_space)):
    ...
    if (!empty($ad_codes)):
        if (trim($ad_codes->ad_code_728) != '') : ?>
            <div class="bn-lg <?php echo(isset($class) ? $class : ''); ?>"style="border-radius: 6px; box-shadow: 0 2px 5px 0 rgba(0,0,0,0.05);background-color: #ffffff;  max-height: 250px;border-radius: 4px;">
                <div class="col-md-12">
                    <div class="row">
                        <!--Include banner-->
