			...
			<div class="col-sm-12 col-md-12">
				...
				<div class="order-details-container">
					<div class="order-head">
						<h2 class="title"><?php echo "Schedule"; ?>:&nbsp;<?php echo $order->order_number; ?></h2>
					</div>
					<div class="order-body">
						...
						if (!empty($shipping)):?>
							<div class="row shipping-container">
								<div class="col-md-12 col-lg-6 m-b-sm-15">
									<h3 class="block-title"><?php echo ("Contact Address"); ?></h3>
						...
						<div class="row table-orders-container">
							<div class="col-12">
								<h3 class="block-title"><?php echo ("Events"); ?></h3>
