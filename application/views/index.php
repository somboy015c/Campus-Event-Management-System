...
<div class="css-slider-wrapper">
  ...
  <div class="maintenance slider slide1" style="padding-top: 0px !important;">
    <div>
      <img src="<?php echo get_logo($general_settings); ?>" alt="logo" style="padding: 10px; height: 40%; width: 40%;">
      <h2>Campus Sports<br/> Events Management</h2>
      <h6 id="result-register" style="text-align: center !important;">
        <b><?php $this->load->view('partials/_messages_skel'); ?></b>
      </h6>
  ...
  <div class="maintenance slider slide2" style="padding-top: 0px !important;">
    <div>
      <img src="<?php echo get_logo($general_settings); ?>" alt="logo" style="padding: 10px; height: 40%; width: 40%;">
  ...
  <div class="maintenance slider slide3" style="padding-top: 0px !important;">
    <div>
      <img src="<?php echo get_logo($general_settings); ?>" alt="logo" style="padding: 10px; height: 40%; width: 40%;">
  ...
  <div class="maintenance slider slide4" style="padding-top: 0px !important;">
    <div>
      <img src="<?php echo get_logo($general_settings); ?>" alt="logo" style="padding: 10px; height: 40%; width: 40%;">
  ...
  <!-- hidden -->
    ...
    <!-- Login Modal -->
    <div class="modal fade" id="loginModal" role="dialog" style="top: 25px;z-index: 999999">
            ...
            <div class="modal-content">
                <div class="auth-box">
                    <button type="button" class="close" data-dismiss="modal"><i class="icon-close"></i></button>
                        ...
                        <h4 class="title mobile-menu" style="border-top: 0px; font-size: 18px; position: absolute; top: 0; left: 0px; max-width: 90%;"><?php echo trans("login"); ?></h4><hr style="margin: 0px; padding: 0px;">
                    <!-- form start -->
                    <form id="form_login" novalidate="novalidate">
                        ...
                        <p class="p-social-media m-0 m-t-5" style="padding-top: 10px;"><?php echo trans("dont_have_account"); ?>&nbsp;<a href="javascript:void(0)" data-toggle="modal" data-target="#RegisterModal" class="link"><?php echo trans("register"); ?></a></p>
                    </form>
                    <!-- form end -->
                </div>
            </div>
    ...
    <!-- Login Modal -->
    <div class="modal fade" id="RegisterModal" role="dialog" style="top: 25px;z-index: 999999">
        <div class="modal-dialog modal-dialog-centered login-modal" role="document" style="line-height: 10px; min-height: 0px;">
            <div class="modal-content">
                <div class="auth-box">
                    <button type="button" class="close" data-dismiss="modal"><i class="icon-close"></i></button>
