            ...
            <div class="auth-box auth-box" style="padding: 0px; width: 280px;">
                <div class="row" style="margin: 0px;">
                            <div class="col-12">
                                ...
                                <p style=" text-align: justify;"><b>Just This Once: </b><?php echo 'Please enter your current location to get connected with your nearest community market places.'; ?></p>
                            </div>
                            <!-- form start -->
