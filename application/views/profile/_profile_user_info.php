        ...
        <div class="profile-details" style="padding: 15px;">
            <div class="row-custom">
                ...
                <div class="row-custom row-profile-username">
                    ...
                    <?php endif; ?>
                    <label class="control-label" style="font-size: 16px;font-weight: 600; padding: 3px 10px 4px 30px;"><?php echo $this->category_model->get_category_by_slug(get_category($user->shop_category_id)->slug)->name . ' Store'; ?></label>
                            <?php if (!empty($user->shop_plan)): ?>
                            <label class="btn btn-sm btn-outline-gray btn-profile-option" style="border-radius: 6px;"><i class="icon-circle"></i>&nbsp;<?php if (strpos($user->shop_plan, 'holesaler') != false) { echo "Wholesaler &nbsp;"; } elseif (strpos($user->shop_plan, 'etailer') != false) { echo "Retailer &nbsp;"; } elseif (strpos($user->shop_plan, 'anufacturer') != false) { echo "Manufacturer &nbsp;"; }  ?></label>
                            <?php endif; ?>
                </div>
                </div>
                ...
                <div class="row-custom user-contact" style="margin: 0px; padding: 0px;">
                    ...
                    <button class="btn btn-md btn-outline-gray" style="padding: 0px; margin: 0px; border: 0px;">
                        <a href="javascript:void(0)" onclick="add_remove_user_favorites('<?php echo $user->id; ?>');">
                        <i class="<?php if (is_user_in_favorites($user->id) == true){echo 'icon-heart';}else{echo 'icon-heart-o';} ?>" id="favorite" style="width: 30px; height: 30px; font-size: 24px; color: #f86923; cursor: pointer; -webkit-transition: all .5s ease-in-out; -moz-transition: all .5s ease-in-out; -ms-transition: all .5s ease-in-out; -o-transition: all .5s ease-in-out; transition: all .5s ease-in-out; z-index: 99; text-shadow: 0 1px 2px #f86923;"></i><span class="count" id="cnt" style="padding-right: 10px; color: #666; <?php if (is_user_in_favorites($user->id) == true){echo 'color: #f86923;';} ?>">Likes (<?php echo get_user_favorited_count($user->id); ?>)</span></a>
                    </button>
                    <button class="btn btn-md btn-outline-gray" style="padding: 0px; margin: 0px; border: 0px;">
                        <a  href="javascript:void(0)" onclick="add_remove_user_unfavorites('<?php echo $user->id; ?>');">
                        <img src="<?php  if (is_user_in_unfavorites($user->id) == true){$like = 'dislike2.png';}else{$like = 'dislikes.png';} echo lang_base_url() . 'assets/img/' . $like; ?>" alt="Dislike" id="unfavorite" style="height: 22px; width: 28px;"><span class="count" id="uncnt" style="padding-left: 8px; vertical-align: bottom; color: #666; <?php if (is_user_in_unfavorites($user->id) == true){echo 'color: #f86923;';} ?>">Dislikes (<?php echo get_user_unfavorited_count($user->id); ?>)</span></a>
                    </button>
            ...
            <div class="row">
                <div class="col-6 buttons" style="margin-top: 15px;">
                    <div class="slide_progress">
                        <div class="d-flex justify-content-between align-items-center">
                            <label class="control-label" style="font-size: 16px;font-weight: 600; padding: 3px 30px 4px 0px;">Shop Storage</label> 
                ...
                <?php if (date_difference($user->shop_end_date, date('Y-m-d H:i:s')) < 100): ?>
                    <div class="col-6 buttons" style="margin-top: 35px; padding-left: 0px;">
            ...
            <div class="row-custom">
                ...
                <div class="col-sm-12 col-md-12" style="margin: 0px; padding: 0px;">
                    <div class="row-custom row-profile-username" style="margin-top: 0px;">
                        ...
                        <?php endif; ?>
                        <label class="username control-label" style="font-size: 13px;font-weight: 600;padding-right: 15px;"><?php echo $this->category_model->get_category_by_slug(get_category($user->shop_category_id)->slug)->name . ' Store'; ?></label>
                        <?php if (!empty($user->shop_plan)): ?>
                        <label class="username btn btn-sm btn-outline-gray btn-profile-option" style="border: 0px; font-size: 12px;line-height: 20px; padding-left: 0px; padding-right: 5px;"><i class="icon-circle"></i>&nbsp;<?php if (strpos($user->shop_plan, 'holesaler') != false) { echo "Wholesaler &nbsp;"; } elseif (strpos($user->shop_plan, 'etailer') != false) { echo "Retailer &nbsp;"; } elseif (strpos($user->shop_plan, 'anufacturer') != false) { echo "Manufacturer &nbsp;"; }  ?></label>
                        <?php endif; ?>
                ...
                <div class="row-custom user-contact" style="margin: 0px; padding: 0px;">
                    ...
                    <button class="btn btn-md btn-outline-gray" style="padding: 0px; margin: 0px; border: 0px;">
                        <a href="javascript:void(0)" onclick="add_remove_user_favorites2('<?php echo $user->id; ?>');">
                        <i class="<?php if (is_user_in_favorites($user->id) == true){echo 'icon-heart';}else{echo 'icon-heart-o';} ?>" id="favorite2" style="width: 30px; height: 30px; font-size: 18px; color: #f86923; cursor: pointer; -webkit-transition: all .5s ease-in-out; -moz-transition: all .5s ease-in-out; -ms-transition: all .5s ease-in-out; -o-transition: all .5s ease-in-out; transition: all .5s ease-in-out; z-index: 99; text-shadow: 0 1px 2px #f86923;"></i><span class="count" id="cnt2" style="padding-right: 10px; font-size: 11px; color: #666; <?php if (is_user_in_favorites($user->id) == true){echo 'color: #f86923;';} ?>">Likes (<?php echo get_user_favorited_count($user->id); ?>)</span></a>
                    </button>
                    <button class="btn btn-md btn-outline-gray" style="padding: 0px; margin: 0px; border: 0px;">
                        <a href="javascript:void(0)" onclick="add_remove_user_unfavorites2('<?php echo $user->id; ?>');">
                            <img src="<?php  if (is_user_in_unfavorites($user->id) == true){$like = 'dislike2.png';}else{$like = 'dislikes.png';} echo lang_base_url() . 'assets/img/' . $like; ?>" alt="Dislike" id="unfavorite2" style="height: 17px; width: 20px;"><span class="count" id="uncnt2" style="padding-left: 8px; vertical-align: bottom; font-size: 11px; color: #666; <?php if (is_user_in_unfavorites($user->id) == true){echo 'color: #f86923;';} ?>">Dislikes (<?php echo get_user_unfavorited_count($user->id); ?>)</span>
                        </a>
                    </button>
                    <label class="btn btn-sm btn-outline-gray btn-profile-option" style="border-radius: 6px; font-size: 11px; vertical-align: middle; border: 0px; margin: 0px;"><?php echo ("Visitors "); ?><span class="count">(<?php echo $user->hit; ?>)</span></label>
...
<div class="main-menu">
        ...
        <div class="row-custom">
     <div class="row-custom">
                <img src="<?php echo get_wshop_avatar($user); ?>" alt="<?php echo get_shop_name($user); ?>" style="max-height: 400px;max-width: 100%; border-radius: 6px">
     </div>
    <div class="profile-details" style="padding: 15px;">
        <div class="row">
            <div class="col" style="padding-left: 0px;">
                <div class="row-custom row-profile-username">
                    ...
                    <?php if ($user->role == 'vendor' || $user->role == 'admin'): ?>
                        <i class="icon-verified icon-verified-member"></i>
                    <?php endif; ?>
                            <?php if (!empty($user->workshop_plan)): ?>
                            <label class="btn btn-sm btn-outline-gray btn-profile-option" style="border-radius: 6px; margin-left: 30px;"><i class="icon-circle"></i>&nbsp;<?php if (strpos($user->workshop_plan, 'asic') != false) { echo "Basic &nbsp;"; } elseif (strpos($user->workshop_plan, 'remium') != false) { echo "Premium &nbsp;"; } elseif (strpos($user->workshop_plan, 'ltimate') != false) { echo "Ultimate &nbsp;"; }  ?></label>
                            <?php endif; ?>
                            <label class="control-label" style="font-size: 16px;font-weight: 600; padding: 3px 10px 4px 30px;"><?php echo $this->category_model->get_category_by_slug(get_category($user->shop_category_id)->slug)->name . ' Workshop'; ?></label>
                </div>
            </div>
            ...
            <div class="row-custom row-profile-username">
                <label class="control-label" style="font-size: 16px;font-weight: 600; padding: 3px 20px 4px 0px;"><?php echo 'Our Specializations:  '; ?></label>
                                <?php if (count($skills) > 0): ?>
                                <?php foreach ($skills as $skill): ?> 
                                    <label style="background-color: #0000ff24; border-radius: 6px; padding-right: 7px; margin-right: 10px; height: 28px; padding-left: 5px;"><i style=" vertical-align: middle; padding: 10px 5px 10px 5px;"><?php echo $skill->skill; ?></i></label>
                                <?php endforeach; ?>
                                <?php endif; ?>
            </div>
            <div class="row-custom user-contact" style="margin-bottom: 0px; padding: 0px;">
                    ...
                    <ul>
                        <?php if (auth_check() && user()->id == $user->id): if (!$user->is_advert): ?>
                            <?php if ($user->is_advert_request == 1): ?>
                                <label class="btn btn-sm btn-outline-gray btn-profile-option"><i class="icon-circle"></i>&nbsp;<?php echo "Processing Advertisement "; ?></label>
                            <?php else: ?>
                                <a href="<?php if ($user->role == 'member'){ $li = 'pending-products'; $ul = 'Work';}else{ $li = 'start-selling'; $ul = 'Shop';} echo lang_base_url() . $li . "?target=" . $ul; ?>" class="btn btn-sm btn-outline-gray btn-profile-option"><i class="icon-plus"></i>&nbsp;<?php if ($ul == 'Work'){$ul = 'Workshop';}else{ $ul = $ul;} echo "Advertise " . $ul; ?></a>
                            <?php endif ?>
                        <?php else: ?>
                            <label class="btn btn-sm btn-outline-gray btn-profile-option"><i class="icon-circle"></i><?php echo ("Advertised"); ?>&nbsp;&nbsp;&nbsp;(<?php echo date_difference($user->advert_end_date, date('Y-m-d H:i:s')) . " " . trans("days_left"); ?>)</label>
                        <?php endif; endif; ?>
        ...
        <?php if (auth_check()): if ($user->id == user()->id && $user->role != 'admin'): ?>
        <div class="row">
            <div class="col-6 buttons" style="margin-top: 15px; padding-left: 0px;">
                <div class="slide_progress">
                    <div class="d-flex justify-content-between align-items-center">
                        <label class="control-label" style="font-size: 16px;font-weight: 600; padding: 3px 30px 4px 0px;">Shop Storage</label> 
                        <p class="mb-0 text-muted"><?php echo get_used_storage_percentage($user) . '% (' . get_used_storage($user->id) . ') of ' . get_storage_space($user) . 'GB Used'; ?></p>
            ...
            <?php if (date_difference($user->workshop_end_date, date('Y-m-d H:i:s')) < 100): ?>
                <div class="col-6 buttons" style="margin-top: 35px; padding-left: 0px;">
                    <?php if ($user->is_workshop == 1) {$req='workshop';} else {$req='';} echo form_open('product_controller/renew_shop'); ?>
                        <input type="hidden" name="id" value="<?php echo $user->id; ?>">
                        <input type="hidden" name="req" value="<?php echo $req; ?>">
        ...
        <div class="right" style="vertical-align: middle;">
                    <a href="javascript:void(0)" data-toggle="modal" data-target="#shareModal"><img src="<?php echo base_url(); ?>assets/img/Shares.png" alt="share" style="width: 40%; height: 40%; "></a>
        </div>
...
<div class="mobile-menu" style="padding-top: 0px; padding-bottom: 5px;">
    <div class="row-custom">
         <div class="row-custom">
            <img src="<?php echo get_shop_avatar($user); ?>" alt="<?php echo get_shop_name($user); ?>" style="max-height: 410px;max-width: 100%; border-radius: 6px">
         </div>
        <div class="profile-details" style="padding: 10px 5px 0px 5px;">
            <div class="row-custom">
                ...
                <div class="col-sm-12 col-md-12" style="margin: 0px; padding: 0px;">
                    <div class="row-custom row-profile-username" style="margin-top: 0px;">
                        ...
                        <?php if ($user->role == 'vendor' || $user->role == 'admin'): ?>
                            <i class="icon-verified icon-verified-member" style="padding-right: 15px;"></i>
                        <?php endif; ?>
                        <label class="username control-label" style="font-size: 12px;font-weight: 600;padding-right: 15px;"><?php echo $this->category_model->get_category_by_slug(get_category($user->shop_category_id)->slug)->name . ' Workshop'; ?></label>
                        <?php if (!empty($user->workshop_plan)): ?>
                        <label class="username btn btn-sm btn-outline-gray btn-profile-option" style="border: 0px; font-size: 12px;line-height: 20px; padding-left: 0px; padding-right: 5px;"><i class="icon-circle"></i>&nbsp;<?php if (strpos($user->workshop_plan, 'asic') != false) { echo "Basic &nbsp;"; } elseif (strpos($user->workshop_plan, 'remium') != false) { echo "Premium &nbsp;"; } elseif (strpos($user->workshop_plan, 'ltimate') != false) { echo "Ultimate &nbsp;"; }  ?></label>
                        <?php endif; ?>
                        <div class="username btn profile-rating" style="padding: 0px 0px 4px 0px;">
                ...
                <div class="row-custom row-profile-username" style="margin: 0px;">
                <label class="control-label" style="font-size: 13px;font-weight: 600; padding: 3px 10px 4px 0px; margin: 0px;"><?php echo 'Our Specializations:  '; ?></label>
                                <?php if (count($skills) > 0): ?>
                                <?php foreach ($skills as $skill): ?> 
                                    <label class="btn btn-md" style="background-color: #dee1e4; border-radius: 6px; font-size: 11px; margin-right: 5px; padding: 0px 0px 1px 6px;"><i style=" vertical-align: middle;"><?php echo $skill->skill; ?></i></label>
                                <?php endforeach; ?>
                                <?php endif; ?>
                </div>
                ...
                <div class="right" style="margin: 0px; padding: 0px;">
                <div class="row-custom profile-buttons" style="margin: 0px; padding: 0px;">
                    <div class="social" style="margin-top: 8px; margin-bottom: 8px;">
                        <ul >
                            <?php if (!empty($user->facebook_url)): ?>
                                <li><a href="<?php echo $user->facebook_url; ?>" target="_blank" style="width: 32px; height: 32px; font-size: 13px; line-height: 32px;"><i class="icon-facebook"></i></a></li>
                            <?php endif; ?>
            ...
            <?php else: ?><div class="col-sm-12 col-md-6" style="margin-top: 10px;"></div><?php endif; ?><?php else: ?><div class="col-sm-12 col-md-6" style="margin-top: 10px;"></div>
            <?php endif; ?>
