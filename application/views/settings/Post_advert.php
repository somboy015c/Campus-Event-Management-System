                                                                    ...
                                                                    <label class="control-label"><?php echo ("Edit and Format Text"); ?></label>
                                                                        ...
                                                                        <div class="card-body">
                                                                            <div id="sl_mid" class="carousel slide slide_widget" data-ride="carousel" data-interval="0">
                                                                                ...
                                                                                <a href="#sl_mid" role="button" data-slide="prev"><div class="nbs-flexisel-nav-left"></div></a><a href="#sl_mid" role="button" data-slide="next"><div class="nbs-flexisel-nav-right"></div></a>
                                                                            </div>
                                                                            <div id="sl_sid" class="carousel slide slide_widget" data-ride="carousel" data-interval="0">
                                                                                ...
                                                                                <a href="#sl_sid" role="button" data-slide="prev"><div class="nbs-flexisel-nav-left"></div></a><a href="#sl_sid" role="button" data-slide="next"><div class="nbs-flexisel-nav-right"></div></a>
                                                                            </div>
                                                                        </div>
                                                                        <center>
                                                                        <div id="bg" class="col-9" style=" background-image: url('<?php echo $bg_images[0]->image; ?>'); background-size: 100% 100%; background-position: center;border-radius: 4px; height: 250px;">
                                                                            <textarea id="text" class="text_place_1" style="font-style: bold; padding: 85px 10px 24px 10px; font-size: 23px; color: <?php echo $bg_images[0]->font_color; ?>; background-color: transparent; border: 0px; resize: none; text-align: center; height: 75% ; width: 100%; overflow: hidden;" maxlength="172" name="text" placeholder="Write on what to advertise" cols= "60" rows="5"></textarea>
                                                                        </div>
                                                                        </center>
